...
public class Modifiers extends Enum {
    ...
    public static final Modifiers PUBLIC = new Modifiers(PUBLIC_ID, PUBLIC_VIEW);

    public static final int STATIC_ID = 2;
    public static final String STATIC_VIEW = "static";
    public static final Modifiers STATIC = new Modifiers(STATIC_ID, STATIC_VIEW);

    public static final int FINAL_ID = 3;
    public static final String FINAL_VIEW = "final";
    public static final Modifiers FINAL = new Modifiers(FINAL_ID, FINAL_VIEW);

    public static final Modifiers[] modifiers = new Modifiers[]{PUBLIC, STATIC, FINAL};
